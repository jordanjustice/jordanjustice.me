      ...
      <Layout>
        ...
        <Prose>
          ...
          <Gig
            ...
            description={
              <>
                ...
                development. Our platform is built with React, Styled
          ...
          <p>
            ...
            pedestrian safety in my beloved City of Toledo. You can see what
            I've been up to most recently on my <Link href="/now">now</Link>{" "}
            page.
          </p>
          <h3>Education</h3>
          <p>
            Being in software development has afforded me with constant
            continuing education. One bit that I'm most proud of is being an{" "}
            <Link href="https://altmba.com/">altMBA</Link> alumni. It's helped
            me learn to know what I see, rather than seeing what I know.
          </p>
          <hr />
          <p>
